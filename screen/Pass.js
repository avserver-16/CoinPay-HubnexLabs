...
const Pass = ({ navigation }) => {
  ...
  return (
    <Background>
        <ImageBackground source={require('./media/Pass.png')}
                    style={{flex: 1,
                        height: 130,
                        width: 420,
      ...
      <TouchableOpacity 
        ...
        style={{
          backgroundColor:'#304FFE',height:80,width:80,justifyContent:'center',alignItems:'center',borderRadius:50,marginBottom:50}}>
